...
namespace Voxelgon.Geometry {
    ...
    public class MeshBuilder : MeshFragment {
        ...
        public override IEnumerable<Color32> Colors32 {
            get { return _colors32; }
        }

        public override IEnumerable<int> Tris {
            get { return _tris; }
        }
        ...
        public IEnumerable<Mesh> Meshes {
            get {
                FinalizeLastMesh();
                foreach(var m in _completedMeshes) { yield return m; }
            }
        }

        public Mesh FirstMesh {
            get { return Meshes.First(); }
        }
