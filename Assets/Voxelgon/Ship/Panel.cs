...
namespace Voxelgon.Ship {
    ...
    public class Panel : ISelectable {
        ...
        public Panel(Hull hull) {
            _PanelPlane = new Plane();
            _hull = hull;
        }
        ...
        public Vector3 Normal {
            get {
                if (IsPolygon) {
                    return ((Plane)_PanelPlane).normal;
                }
                return Vector3.zero;
            }
        }
        ...
        public Bounds Bounds {
            get { return _meshBuilder.Bounds; }
        }
        ...
        public Vector3 GetEdgeNormal(Edge edge) {
            ...
            throw new ArgumentOutOfRangeException("edge", "edge not present in this Panel");
        }
